...
function Hospital() {
    const [data, setData] = useState<Post[]>([
        { id: 1, placeName: '케어키즈 소아과', region: '강남구', type: '소아과', createdAt: '2024-06-28', address: '서울시 강남구', phone: '010-1234-5678', openHour: '09:00-18:00' },
        { id: 2, placeName: '키즈케어 약국', region: '관악구', type: '약국', createdAt: '2024-06-28', address: '서울시 관악구', phone: '010-1234-5678', openHour: '09:00-18:00' },
    ]);
        ...
        <div className="App">
            ...
            <div className="container mt-4">
             ...
             <Modal isOpen={modal} toggle={toggle}>
                ...
                <ModalFooter>
                    <Button color="primary" onClick={handleSubmit} disabled={!!fileError || !newPost.placeName || !newPost.region || !newPost.address || !newPost.phone|| !newPost.openHour }>등록</Button>{' '}
                    ...
                    <Form>
                        ...
                        <FormGroup>
                            ...
                            <Input 
                                ...
                                name="type" 
                                id="type" 
                                value={newPost.type || currentPost?.type || ''}
                                onChange={(e) => setNewPost({...newPost, type: e.target.value})}
                            >
                                <option value="">선택하세요</option>
                                <option>소아과</option>
